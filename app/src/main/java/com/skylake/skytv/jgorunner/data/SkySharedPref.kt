...
class SkySharedPref(context: Context) {
    ...
    data class SharedPrefStructure(
        ...
        @SharedPrefKey("dynamicZoneTabUrl") var dynamicZoneTabUrl: String? = "https://raw.githubusercontent.com/atanuroy22/zee5/main/tab.json",
        @SharedPrefKey("dynamicZoneTabJson") var dynamicZoneTabJson: String? = "",
        @SharedPrefKey("dynamicZoneTabEnabled") var dynamicZoneTabEnabled: Boolean = false,
        @SharedPrefKey("dynamicZoneTabName") var dynamicZoneTabName: String? = "",
        @SharedPrefKey("dynamicZoneTabLastUpdated") var dynamicZoneTabLastUpdated: Long = 0L,
